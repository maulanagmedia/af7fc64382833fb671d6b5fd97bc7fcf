...
public class NewsPromoAdapter extends RecyclerView.Adapter<NewsPromoAdapter.MyViewHolder> {
    ...
    public NewsPromoAdapter(Context context, List<CustomItem> masterList, int menuWidth, int size){
    ...
    public void AddMoreData(List items){
