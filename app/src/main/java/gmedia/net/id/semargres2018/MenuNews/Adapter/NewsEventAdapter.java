...
public class NewsEventAdapter extends RecyclerView.Adapter<NewsEventAdapter.MyViewHolder> {
    ...
    public NewsEventAdapter(Context context, List<CustomItem> masterList, int menuWidth, int size){
    ...
    public void AddMoreList(List items){
...
//        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(iv.dpToPx(context,(menuWidth - 49)), iv.dpToPx(context,(menuWidth - 49)));
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(menuWidth,menuWidth + iv.dpToPx(context, 10));
